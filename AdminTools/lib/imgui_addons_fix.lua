...
module.ToggleButton = function(str_id, bool)
	...
	local r, g, b = 154, 140, 207
	local alpha = 1.0
	local purple_color = imgui.ImVec4(r / 255.0, g / 255.0, b / 255.0, alpha)
	draw_list:AddCircleFilled(imgui.ImVec2(p.x + radius + t * (width - radius * 2.0), p.y + radius), radius - 0.75, imgui.GetColorU32(bool.v and purple_color or imgui.ImColor(150, 150, 150, 255):GetVec4()))
